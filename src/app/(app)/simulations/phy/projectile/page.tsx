...
export default function ProjectileMotionSimulation() {
  ...
  useEffect(() => {
    ...
    const animate = (timestamp: number) => {
      ...
      const y = startY - (height + vy * currentTime - 0.5 * gravity * currentTime * currentTime) * 5 // Inverted y-axis
  ...
  const drawProjectile = (positions: { x: number; y: number }[], currentX: number, currentY: number) => {
    ...
    if (!isRunning || time < 0.1) {
      ...
      ctx.lineTo(50 + Math.cos(angleRad) * 50, 350 - height * 5 - Math.sin(angleRad) * 50)
        ...
        <div className="lg:col-span-2">
          <Card className="w-full h-full">
            <CardHeader>
              ...
              <CardDescription>Observe how the projectile moves based on the parameters you set</CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col items-center">
              ...
              <div className="mt-4 text-sm text-gray-500">Time: {time.toFixed(2)}s</div>
            </CardContent>
          </Card>
        </div>
        ...
        <div>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Adjust these values to see how they affect the projectile's motion</CardDescription>
            </CardHeader>
